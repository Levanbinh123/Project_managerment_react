...
export const INVITE_PROJECT_REQUEST="INVITE_PROJECT_REQUEST";
export const INVITE_PROJECT_SUCCESS="INVITE_PROJECT_SUCCESS";
export const INVITE_PROJECT_FAILURE="INVITE_PROJECT_FAILURE";
